...
public class FirstActivity extends Activity implements
	...
	static String optionERFragment;
	/**
	...
	public void onNavigationDrawerItemSelected(int position) {
		...
		switch (position) {
		case 0:
			LibraryFragment lfrag = new LibraryFragment();
			transaction.replace(R.id.container, lfrag, "VivzFragment2");
			transaction.commit();
			break;
		case 1:
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public void onAttach(Activity activity) {
			...
			((FirstActivity) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
